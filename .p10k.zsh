# Generated by Powerlevel10k configuration wizard on 2024-10-05 at 20:55 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=093
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=156
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=228
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=243
  ...
  # Context color in SSH with root privileges.
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_SUDO_FOREGROUND=3
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_SUDO_BACKGROUND=0
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_FOREGROUND=000
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_BACKGROUND=221
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=015
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=241
...
# Updates the prompt's time live
